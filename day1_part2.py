...
Current frequency  4, change of -2; resulting frequency  2, which has alreadybeen seen.
...
# Note: puzzle inputs differ by user (but same as part 1)
freq = 0
seen = set()
ans = None
for num in cycle(day1_inputs):
    freq += num
    if freq not in seen:
        seen.update([freq])
    else:
